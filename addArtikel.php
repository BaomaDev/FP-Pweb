...
if ($act == "i") {
    if (isset($_POST['judul']) && isset($_POST['content'])) {
        ...
        // Get user_id based on the currently logged-in user
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form class="border p-3 container" style="background-color:#D6EEE4" method="post" action="?a=i" onsubmit="return validateForm()">
            <table style="width: 100%">
                <tr>
